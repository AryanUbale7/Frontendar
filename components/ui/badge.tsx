...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#DEE32E] focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "bg-[#DEE32E]/10 text-[#DEE32E] border border-[#DEE32E]/20",
        primary:
          "bg-[#DEE32E]/10 text-[#DEE32E] border border-[#DEE32E]/20",
        secondary:
