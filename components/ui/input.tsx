      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              "flex h-10 w-full rounded-[12px] border border-[#E2E8F0] bg-white px-3 py-2 text-sm text-[#0F172A] placeholder:text-[#94A3B8] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ACC00B] focus-visible:border-transparent disabled:cursor-not-allowed disabled:opacity-50",
              leftIcon && "pl-10",
              rightIcon && "pr-10",
