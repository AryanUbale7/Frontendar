        ...
        >
          <div className="relative flex items-center mt-0.5">
            <input
              ...
              {...props}
            />
            <div className="h-4 w-4 rounded-[6px] border border-[#CBD5E1] bg-white transition-all peer-checked:bg-[#FF006E] peer-checked:border-[#FF006E] peer-focus-visible:ring-2 peer-focus-visible:ring-[#FF006E] peer-focus-visible:ring-offset-1" />
