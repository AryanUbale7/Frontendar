...
export function Footer() {
  return (
    <footer className="w-full bg-white border-t border-[#E2E8F0] mt-auto relative overflow-hidden">
      ...
      <div className="h-1.5 w-full bg-gradient-to-r from-[#0F172A] via-[#FF8A00] to-[#FFD60A]" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start mb-12">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm font-semibold text-[#334155]">
                {FOOTER_SECTIONS.quickLinks.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="hover:text-[#0F172A] transition-colors">
                      {link.label}
                    </a>
                  </li>
                ))}
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm font-semibold text-[#334155]">
                <li><a href="#featured-hackathons" className="hover:text-[#0F172A] transition-colors">Frontend Wars</a></li>
                <li><a href="#featured-hackathons" className="hover:text-[#0F172A] transition-colors">UI/UX Sprints</a></li>
                <li><a href="#featured-hackathons" className="hover:text-[#0F172A] transition-colors">AI Build Challenges</a></li>
                <li><a href="#featured-hackathons" className="hover:text-[#0F172A] transition-colors">Open Source</a></li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-10 text-center pt-4 border-t border-[#E2E8F0] w-full max-w-sm">
              <div className="space-y-2">
                ...
                <ul className="space-y-2 text-sm font-semibold text-[#334155]">
                  <li><a href="#" className="hover:text-[#0F172A] transition-colors">Help Center</a></li>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2 text-sm font-semibold text-[#334155]">
                  <li><a href="/privacy-policy" className="hover:text-[#0F172A] transition-colors">Privacy Policy</a></li>
                  <li><a href="/terms-of-service" className="hover:text-[#0F172A] transition-colors">Terms of Service</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="p-5 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-4 shadow-2xs">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label="GitHub"
                  className="flex h-11 w-11 items-center justify-center rounded-xl bg-white border border-[#E2E8F0] text-[#0F172A] hover:bg-[#0F172A] hover:text-white hover:border-[#0F172A] transition-all shadow-xs"
                >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[#E2E8F0] text-sm text-[#475569] font-medium">
          ...
          <div className="flex items-center gap-6 font-semibold">
            <a href="/privacy-policy" className="hover:text-[#0F172A] transition-colors">Privacy Policy</a>
            <a href="/terms-of-service" className="hover:text-[#0F172A] transition-colors">Terms of Service</a>
            <a href="/community-guidelines" className="hover:text-[#0F172A] transition-colors">Community Guidelines</a>
          </div>
        </div>
      </div>
    </footer>
