...
export function Footer() {
  return (
    <footer className="w-full bg-[#0B0F17] text-white mt-auto relative overflow-hidden">
      {/* Top Accent Gradient Border matching CTA section */}
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2.5 group cursor-pointer">
              <div className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-black p-1 shadow-md group-hover:scale-105 transition-transform border border-white/10">
                <img
                  src="/logo.png"
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#1E293B] bg-[#0F172A] text-[#94A3B8] hover:bg-[#FF006E] hover:text-white hover:border-[#FF006E] transition-all"
              >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[#1E293B] text-xs text-[#94A3B8]">
