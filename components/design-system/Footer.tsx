          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2.5 group cursor-pointer">
              ...
              <div className="flex flex-col">
                <span className="font-heading text-base font-bold text-[#0F172A] tracking-tight">
                  {BRAND_CONFIG.name}
                </span>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#E2E8F0] bg-[#F8FAFC] text-[#475569] hover:bg-[#FF006E] hover:text-white hover:border-[#FF006E] transition-all shadow-2xs"
              >
