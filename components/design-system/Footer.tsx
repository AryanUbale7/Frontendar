...
export function Footer() {
  return (
    <footer className="w-full bg-white border-t border-[#E2E8F0] mt-auto relative overflow-hidden">
      ...
      <div className="h-1 w-full bg-gradient-to-r from-[#FF006E] via-[#FF8A00] to-[#FFD60A]" />

      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-14">
        {/* Layout matching user hand-drawn paper sketch */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start mb-10">
          {/* Left Section: 2 Link Columns */}
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              <h4 className="font-heading text-xs font-bold uppercase tracking-wider text-[#0F172A]">
                Quick Links
              </h4>
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            <div className="space-y-3 flex flex-col items-center group cursor-pointer">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-black p-2.5 shadow-md border border-[#E2E8F0] group-hover:scale-105 transition-transform">
                <img
                  src="/logo.png"
              ...
              <div className="space-y-0.5">
                <h3 className="font-heading text-xl font-extrabold text-[#0F172A] tracking-tight">
                  Frontend Arena
                </h3>
            ...
            <div className="grid grid-cols-2 gap-8 text-center pt-3 border-t border-[#E2E8F0] w-full max-w-xs">
              <div className="space-y-1.5">
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#0F172A]">Support</span>
                <ul className="space-y-1 text-xs font-medium text-[#475569]">
              ...
              <div className="space-y-1.5">
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#0F172A]">Legal</span>
                <ul className="space-y-1 text-xs font-medium text-[#475569]">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-3 shadow-2xs">
              <h5 className="font-heading text-xs font-bold uppercase tracking-wider text-[#0F172A]">
                Social Links
              </h5>
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label="GitHub"
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-[#E2E8F0] text-[#0F172A] hover:bg-[#FF006E] hover:text-white hover:border-[#FF006E] transition-all shadow-xs"
                >
