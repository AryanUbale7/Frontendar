  ...
  return (
    <footer className="w-full border-t border-[#E2E8F0] bg-white mt-auto">
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3 md:col-span-1">
            <div className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-[10px] bg-gradient-to-br from-[#2563EB] to-[#06B6D4] text-white">
          ...
          <div className="space-y-2.5">
            <h4 className="font-heading text-xs font-semibold uppercase tracking-wider text-[#0F172A]">
              Quick Links
            </h4>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-8 w-8 items-center justify-center rounded-[8px] border border-[#E2E8F0] bg-[#F8FAFC] text-[#475569] hover:bg-[#2563EB] hover:text-white hover:border-[#2563EB] transition-all"
              >
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[#E2E8F0] text-xs text-[#475569]">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="hover:text-[#0F172A]">Community Guidelines</a>
          </div>
        </div>
      </div>
    </footer>
