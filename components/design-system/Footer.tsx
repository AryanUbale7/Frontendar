...
export function Footer() {
  return (
    <footer className="w-full border-t border-[#1E293B] bg-[#0B0F17] mt-auto">
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Brand Col */}
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-black p-0.5 border border-[#1E293B] shadow-sm">
                <img
                  src="/logo.png"
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-8 w-8 items-center justify-center rounded-[8px] border border-[#1E293B] bg-[#0F172A] text-[#94A3B8] hover:bg-[#FF006E] hover:text-white hover:border-[#FF006E] transition-all"
              >
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-[#1E293B] text-xs text-[#64748B]">
