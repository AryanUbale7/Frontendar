  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-[#0F172A] text-white font-heading font-semibold text-xs shadow-sm overflow-hidden ring-2 ring-white">
            {user.avatarUrl ? (
