  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="relative flex flex-col items-center w-full max-w-[700px] mx-auto select-none px-4 sm:px-8">
          ...
          <motion.div
            ...
            className="absolute -top-10 left-0 sm:left-4 z-20 bg-slate-950 text-white rounded-[28px] p-5 shadow-lg max-w-[200px] text-left border border-slate-900"
          >
            <span className="font-heading text-4xl font-extrabold text-white block mb-2">99%</span>
          ...
          <motion.div
            ...
            className="absolute bottom-10 -left-6 sm:-left-12 z-20 bg-white border border-slate-200/60 rounded-[28px] p-5 shadow-lg max-w-[170px] text-left"
          >
            <span className="font-heading text-3xl font-extrabold text-[#0F172A] block mb-2">500+</span>
          ...
          <motion.div
            ...
            className="absolute top-14 -right-4 sm:-right-10 z-20 bg-white border border-slate-200/60 rounded-[28px] p-5 shadow-lg max-w-[170px] text-left"
          >
            <span className="font-heading text-3xl font-extrabold text-[#0F172A] block mb-2">20+</span>
            <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
          ...
          <motion.div
            ...
            className="absolute -bottom-8 -right-2 sm:right-2 z-20 bg-white border border-slate-200/60 rounded-[28px] p-5 shadow-lg w-[320px] max-w-full text-left"
          >
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex gap-2">
                {["React", "Next.js", "Tailwind"].map((tag) => (
                  <span
                    key={tag}
                    className="px-3.5 py-1.5 bg-white border border-slate-200 rounded-full text-xs font-semibold text-slate-700 shadow-2xs hover:bg-slate-50 transition-colors"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <motion.div
            ...
            className="relative w-full max-w-[650px] h-[340px] sm:h-[400px] rounded-[36px] overflow-hidden border border-slate-200/60 shadow-xl shadow-slate-100/50 transition-transform duration-500 hover:scale-[1.01] z-10"
          >
            <img
        ...
        <div className="flex flex-col items-center justify-center mt-16 z-20 relative w-full">
          <motion.div
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
