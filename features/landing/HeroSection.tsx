...
export function HeroSection() {
  return (
    <section id="hero" className="relative py-12 sm:py-16 md:py-28 overflow-hidden bg-gradient-to-b from-[#FFF2F7] via-[#FFFBEB] to-[#F8FAFC]">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#FF006E/[0.03]_1px,transparent_1px),linear-gradient(to_bottom,#FF006E/[0.03]_1px,transparent_1px)] bg-[size:3rem_3rem] sm:bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_30%,#000_70%,transparent_100%)] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center space-y-5 sm:space-y-6 max-w-4xl mx-auto">
          ...
          >
            <Badge variant="accent" size="md" dot className="bg-[#FFD60A] text-[#0F172A] border-[#FFD60A] font-bold text-xs sm:text-sm px-3 py-1">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 pt-2 w-full sm:w-auto"
          >
