...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[85vh] flex items-center justify-center py-16 md:py-20 overflow-hidden bg-[#FAFAF8] selection:bg-rose-500/10 selection:text-rose-900"
    >
      {/* Background Decorative Gradients/Blobs */}
      <div className="absolute top-[-10%] left-[-15%] w-[450px] md:w-[750px] h-[450px] md:h-[750px] bg-blue-50/15 rounded-full blur-[100px] md:blur-[180px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] md:w-[700px] h-[400px] md:h-[700px] bg-pink-50/10 rounded-full blur-[100px] md:blur-[170px] pointer-events-none" />
      <div className="absolute top-[20%] right-[10%] w-[350px] md:w-[550px] h-[350px] md:h-[550px] bg-yellow-50/10 rounded-full blur-[100px] md:blur-[150px] pointer-events-none" />

      {/* Elegant Technical Background Grid with subtle Parallax */}
      <div
        className="absolute inset-0 bg-[linear-gradient(to_right,#E2E8F0/[0.025]_1px,transparent_1px),linear-gradient(to_bottom,#E2E8F0/[0.025]_1px,transparent_1px)] bg-[size:6rem_6rem] pointer-events-none"
        style={{
      ...
      <div className="absolute inset-0 pointer-events-none select-none z-0">
        {/* Code tag left */}
        <div
          className="absolute left-[8%] top-[28%] text-xs font-mono font-bold text-slate-300 flex items-center gap-1.5 opacity-60"
          style={{
        ...
        {/* Braces right */}
        <div
          className="absolute right-[10%] top-[33%] text-xs font-mono font-bold text-slate-300 flex items-center gap-1.5 opacity-60"
          style={{
        ...
        <div
          className="absolute left-[12%] bottom-[28%] text-[10px] font-mono font-bold text-slate-300 opacity-30 tracking-wider"
          style={{
        ...
        {/* Trophy right bottom */}
        <div
          className="absolute right-[12%] bottom-[30%] text-xs font-mono font-bold text-slate-300 flex items-center gap-1.5 opacity-65"
          style={{
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center space-y-6 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="px-3.5 py-1.5 bg-white border border-slate-200/60 rounded-full text-xs font-bold text-slate-400 shadow-3xs flex items-center gap-1.5 max-w-fit mx-auto"
          >
          ...
          <motion.h1
            ...
            className="font-heading text-4xl sm:text-7xl lg:text-[88px] font-extrabold tracking-tight text-[#101828] leading-[1.0] max-w-5xl mx-auto"
          >
            {/* Line 1 */}
            <span className="block sm:inline-block">
              Build.{" "}
              <span className="inline-block align-middle mx-1.5 sm:mx-3 w-[80px] sm:w-[130px] lg:w-[160px] h-[36px] sm:h-[55px] lg:h-[65px] rounded-full overflow-hidden border border-slate-200/80 shadow-xs transition-transform duration-300 hover:scale-105 select-none pointer-events-none">
                <img
          ...
          >
            <Button
              ...
              variant="default"
              size="lg"
              className="w-full sm:w-auto shadow-xs rounded-full h-14 px-8 font-bold"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto bg-[#0F172A]/90 hover:bg-[#0F172A] text-white border-transparent rounded-full h-14 px-8 font-bold shadow-xs transition-colors"
            >
              <a
          ...
          <motion.div
            ...
            className="pt-8 text-[10px] sm:text-xs font-bold text-slate-400 tracking-[0.25em]"
          >
