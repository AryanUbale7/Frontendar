      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {COMMUNITY_STATS.map((stat, idx) => (
            ...
            >
              <Card className="p-4 sm:p-6 text-center space-y-2 hover:border-[#00E5FF]/40 hover:shadow-lg transition-all duration-300">
                <span className="font-heading text-3xl sm:text-5xl font-extrabold text-[#00E5FF] block">
