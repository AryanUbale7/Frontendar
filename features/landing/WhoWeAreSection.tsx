        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            return (
              ...
              >
                <Card className="h-full p-6 space-y-4 hover:border-[#0F172A]/40 hover:shadow-md transition-all duration-300">
                  <div className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-[#0F172A]/10 text-[#0F172A]">
