      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 space-y-12">
        ...
        >
          ...
          <button
            ...
            className="absolute left-2 md:left-8 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg border border-[#E2E8F0] text-[#0F172A] hover:bg-[#00E5FF] hover:text-white transition-all hover:scale-110 active:scale-95"
          >
          ...
          <button
            ...
            className="absolute right-2 md:right-8 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg border border-[#E2E8F0] text-[#0F172A] hover:bg-[#00E5FF] hover:text-white transition-all hover:scale-110 active:scale-95"
          >
                ...
                >
                  <Card
                    className={`h-[330px] flex flex-col justify-between rounded-3xl border overflow-hidden transition-all duration-300 ${
                      isActive
                        ? "border-[#00E5FF] bg-white ring-4 ring-[#00E5FF]/15 shadow-2xl"
                  ...
                  >
                    ...
                    <div
                      className={`h-1.5 w-full bg-gradient-to-r ${
                        isActive
                          ? "from-[#00E5FF] via-[#FF8A00] to-[#FFD60A]"
                    ...
                    <CardHeader className="space-y-5 p-6 flex-1 flex flex-col justify-between">
                      <div className="flex items-center justify-between">
                        <div
                          className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#00E5FF] to-[#FFD60A] text-white shadow-lg transition-transform duration-300 ${
                            isActive ? "scale-105 shadow-[#00E5FF]/30" : ""
                          }`}
                        >
                        ...
                        <Badge
                          ...
                          size="sm"
                          className={isActive ? "bg-[#00E5FF] text-white font-bold" : "text-[#475569]"}
                        >
                          {item.tag}
                        </Badge>
                      </div>
                      ...
                      <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between">
                        <span className="text-xs font-semibold text-[#0F172A] flex items-center gap-1.5">
                          <MetricIcon className="h-3.5 w-3.5 text-[#00E5FF]" />
