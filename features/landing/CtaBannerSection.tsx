    ...
    <section className="py-16 bg-white border-t border-[#E2E8F0]">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[16px] bg-gradient-to-r from-[#FF006E] to-[#FFD60A] p-8 md:p-14 text-white shadow-xl flex flex-col items-center text-center space-y-6"
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-white text-[#FF006E] hover:bg-[#FFF2F7] hover:text-[#FF006E] border-white font-semibold"
            >
