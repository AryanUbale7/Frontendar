    ...
    <section id="why-join" className="py-16 md:py-24 bg-white border-t border-[#E2E8F0] overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 md:px-6 space-y-12">
        ...
        >
          ...
          <button
            onClick={prevSlide}
            className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-20 h-10 w-10 items-center justify-center rounded-full border border-[#E2E8F0] bg-white text-[#DEE32E] shadow-md hover:bg-[rgba(222,227,46,0.08)] hover:border-[#DEE32E]/40 transition-all duration-300 cursor-pointer"
          ...
          <button
            onClick={nextSlide}
            className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-20 h-10 w-10 items-center justify-center rounded-full border border-[#E2E8F0] bg-white text-[#DEE32E] shadow-md hover:bg-[rgba(222,227,46,0.08)] hover:border-[#DEE32E]/40 transition-all duration-300 cursor-pointer"
            ...
            >
              {WHY_JOIN_BENEFITS.map((item) => {
                ...
                return (
                  ...
                  >
                    <Card className="h-full p-6 space-y-4 hover:border-[#DEE32E]/40 hover:shadow-md transition-all duration-300 bg-white border border-[#E2E8F0]">
                      <div className="flex h-11 w-11 items-center justify-center rounded-[12px] bg-[#DEE32E]/10 text-[#DEE32E]">
            ...
            {Array.from({ length: maxIndex + 1 }).map((_, idx) => (
              <button
                ...
                className={cn(
                  ...
                  currentIndex === idx
                    ? "bg-[#DEE32E] w-6"
                    : "bg-[#E2E8F0] hover:bg-[#DEE32E]/40 w-2"
                )}
