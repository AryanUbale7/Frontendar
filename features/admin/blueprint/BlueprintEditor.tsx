    ...
    <div className="space-y-6">
      {onClose && (
        <button
          type="button"
          onClick={onClose}
          className="flex items-center gap-1 text-xs text-[#FF006E] font-bold hover:underline mb-2"
        >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-white border border-[#E2E8F0] rounded-2xl shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="flex h-9 rounded-md border border-[#E2E8F0] bg-white px-3 py-1.5 text-xs font-semibold text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#FF006E]"
          >
            {hackathons.map((h) => (
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 h-9 bg-[#FF006E] text-white hover:bg-[#D8005C] shadow-sm font-bold text-xs rounded-lg transition-all"
          >
          ...
          {sections.map((sec, idx) => (
            <button
              ...
              className={`w-full flex flex-col items-start text-left p-3 rounded-xl transition-all ${
                activeSection === idx
                  ? "bg-[#FF006E]/5 border border-[#FF006E]/30 text-[#FF006E]"
          ...
          <Card className="rounded-2xl border-[#E2E8F0] bg-white shadow-sm overflow-hidden min-h-[500px] flex flex-col justify-between">
            <CardHeader className="border-b border-[#F1F5F9] bg-[#F8FAFC]/30">
              <CardTitle className="text-base font-bold text-[#0F172A] flex items-center gap-2">
                <Sliders className="h-4.5 w-4.5 text-[#FF006E]" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center justify-between p-3 border rounded-xl bg-slate-50/50">
                        ...
                        <input
                          ...
                          className="h-4 w-4 rounded border-slate-300 text-[#FF006E]"
                        />
                      </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full p-2 border rounded-xl text-xs bg-white focus:ring-[#FF006E] focus:border-[#FF006E]"
                      />
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        className="w-full p-2 border rounded-xl bg-white focus:ring-[#FF006E] focus:border-[#FF006E]"
                      >
                    ...
                    {Object.keys(codeQuality).map((key) => (
                      <div key={key} className="space-y-1">
                        <label className="text-[10px] font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                          ...
                          <span className="text-[#FF006E]">{(codeQuality as any)[key]}%</span>
                        </label>
                        <input
                          type="range"
                          min="0"
                          ...
                          className="w-full h-1 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#FF006E]"
                        />
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#FF006E]">{lighthouseMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#FF006E]">{accessibilityMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#FF006E]">{seoMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#FF006E]">{bestPracticesMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
        ...
        <div className="fixed inset-0 bg-[#0F172A]/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[85vh] flex flex-col border border-[#E2E8F0] overflow-hidden">
            <div className="p-5 border-b border-[#F1F5F9] flex items-center justify-between bg-[#F8FAFC]">
              <div className="flex items-center gap-2">
                <Terminal className="h-5 w-5 text-[#FF006E]" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 h-9 rounded-md border border-[#E2E8F0] px-3 text-xs focus:ring-1 focus:ring-[#FF006E] focus:outline-none"
                ...
                <div className="space-y-5 pt-4 border-t border-[#F1F5F9] animate-in fade-in duration-200">
                  ...
                  <div className="flex justify-between items-center bg-[#F0FDF4] p-4 rounded-xl border border-[#BBF7D0]">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-2xl font-black text-[#FF006E] font-heading">
                      ...
                      {previewReport.scoringDetails?.map((detail: any, idx: number) => (
                        <div key={idx} className="p-3 border border-slate-200 rounded-xl bg-white space-y-2 hover:shadow-xs transition-all">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-extrabold text-xs text-[#FF006E]">
