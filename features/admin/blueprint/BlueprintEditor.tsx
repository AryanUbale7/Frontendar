    ...
    <div className="space-y-6">
      {onClose && (
        <button
          type="button"
          onClick={onClose}
          className="flex items-center gap-1 text-xs text-[#2563EB] font-bold hover:underline mb-2"
        >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-white border border-[#E2E8F0] rounded-2xl shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="flex h-9 rounded-md border border-[#E2E8F0] bg-white px-3 py-1.5 text-xs font-semibold text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
          >
            {hackathons.map((h) => (
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 h-9 bg-[#2563EB] text-white hover:bg-[#D8005C] shadow-sm font-bold text-xs rounded-lg transition-all"
          >
          ...
          {sections.map((sec, idx) => (
            <button
              ...
              className={`w-full flex flex-col items-start text-left p-3 rounded-xl transition-all ${
                activeSection === idx
                  ? "bg-[#2563EB]/5 border border-[#2563EB]/30 text-[#2563EB]"
                      ...
                      <div key={idx} className="p-4 border border-[#E2E8F0] rounded-xl bg-[#F8FAFC]/50 space-y-4 relative">
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            className="flex min-h-[100px] w-full rounded-[12px] border border-[#E2E8F0] px-3 py-2 text-xs focus:ring-1 focus:ring-[#2563EB] focus:outline-none bg-white text-[#0F172A]"
                          />
                        </div>
                          ...
                          <button
                            ...
                            className={`px-3 py-2 rounded-lg text-xs font-bold transition-all border ${
                              selectedFeaturePsIdx === psIdx
                                ...
                                : "bg-white text-[#475569] border-[#E2E8F0] hover:border-[#2563EB]/40"
                            }`}
                          >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full p-2 border rounded-xl text-xs bg-white focus:ring-[#2563EB] focus:border-[#2563EB]"
                      />
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        className="w-full p-2 border rounded-xl bg-white focus:ring-[#2563EB] focus:border-[#2563EB]"
                      >
                    ...
                    {Object.keys(codeQuality).map((key) => (
                      <div key={key} className="space-y-1">
                        <label className="text-[10px] font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                          ...
                          <span className="text-[#2563EB]">{(codeQuality as any)[key]}%</span>
                        </label>
                        <input
                          type="range"
                          min="0"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#2563EB]">{lighthouseMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#2563EB]">{accessibilityMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#2563EB]">{seoMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#0F172A] flex justify-between">
                        ...
                        <span className="text-[#2563EB]">{bestPracticesMin}</span>
                      </label>
                      <input
                        type="range"
                        min="50"
                ...
                <div className="space-y-4">
                  <div className="space-y-1 border-b border-[#F1F5F9] pb-2">
                    <h4 className="text-xs font-bold text-[#0F172A] flex items-center justify-between">
                      ...
                      <Badge variant="solid" className="bg-[#2563EB] text-white">FAIE v2.0</Badge>
                    </h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="flex min-h-[160px] w-full rounded-[12px] border border-[#E2E8F0] px-3 py-2 text-xs focus:ring-1 focus:ring-[#2563EB] focus:outline-none font-code leading-relaxed"
                    />
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 h-9 rounded-md border border-[#E2E8F0] px-3 text-xs focus:ring-1 focus:ring-[#2563EB] focus:outline-none"
                ...
                <div className="space-y-5 pt-4 border-t border-[#F1F5F9] animate-in fade-in duration-200">
                  ...
                  <div className="flex justify-between items-center bg-[#F0FDF4] p-4 rounded-xl border border-[#BBF7D0]">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-2xl font-black text-[#2563EB] font-heading">
