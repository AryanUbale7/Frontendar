              ...
              <div className="space-y-6">
                {activePortalTab === "problem" && (
                  !hackathon.problemReleased ? (
                    <Card className="p-12 text-center bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200 flex flex-col items-center justify-center space-y-4">
                      <div className="p-4 rounded-full bg-rose-50 text-[#ACC00B]">
                    ...
                    <Card className="p-6 space-y-6 bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200">
                      <div className="space-y-3 border-b border-[#F1F5F9] pb-4">
                              ...
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                                  activeProblemIdx === sIdx
                                    ? "bg-[#ACC00B] text-white shadow-sm"
                                    : "bg-[#F8FAFC] text-[#475569] border border-[#E2E8F0] hover:bg-[#ACC00B]/5 hover:text-[#ACC00B]"
                        ...
                        <h2 className="font-heading text-lg font-bold text-[#0F172A] flex items-center gap-2">
                          <FileCode2 className="h-5 w-5 text-[#ACC00B]" />
                ...
                {activePortalTab === "rules" && (
                  <Card className="p-6 bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200">
                    <div className="space-y-1.5 border-b border-[#F1F5F9] pb-4 mb-4">
                      <h2 className="font-heading text-lg font-bold text-[#0F172A] flex items-center gap-2">
                        <BookOpen className="h-5 w-5 text-[#ACC00B]" />
                ...
                {activePortalTab === "resources" && (
                  <Card className="p-6 bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200">
                    <div className="space-y-1.5 border-b border-[#F1F5F9] pb-4 mb-4">
                      <h2 className="font-heading text-lg font-bold text-[#0F172A] flex items-center gap-2">
                        <LinkIcon className="h-5 w-5 text-[#ACC00B]" />
                    ...
                    {hackathon.resources.length > 0 ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {hackathon.resources.map((res, resIdx) => (
                          <div
                            key={resIdx}
                            className="p-4 border border-[#E2E8F0] rounded-xl flex items-start justify-between gap-4 hover:border-[#ACC00B]/30 transition-all bg-[#F8FAFC]"
                          >
                            <div className="space-y-1">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="p-2 rounded-lg bg-white border border-[#E2E8F0] text-[#475569] hover:bg-[#ACC00B] hover:text-white hover:border-[#ACC00B] transition-all"
                            >
                ...
                {activePortalTab === "submit" && (
                  <Card className="p-6 bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200 space-y-6">
                    <div className="space-y-1.5 border-b border-[#F1F5F9] pb-4">
                      <h2 className="font-heading text-lg font-bold text-[#0F172A] flex items-center gap-2">
                        <GitPullRequest className="h-5 w-5 text-[#ACC00B]" />
                      ...
                      {[
                        ...
                        <div key={s.step} className="space-y-1.5">
                          <div className={`h-2 rounded-full transition-all ${
                            submissionStep >= s.step ? "bg-[#ACC00B]" : "bg-slate-100"
                          }`} />
                          <span className={`text-[9px] font-black uppercase tracking-wider block ${
                            submissionStep === s.step ? "text-[#ACC00B]" : "text-slate-400"
                          }`}>{s.label}</span>
                        </div>
                      ))}
                    </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#F1F5F9] pb-5">
                              <div className="space-y-1.5">
                                <div className="flex flex-wrap items-center gap-2.5">
                                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-rose-50 border border-rose-200 text-[#ACC00B] text-[10px] font-mono font-bold tracking-wider uppercase">
                                    <ShieldCheck className="w-3.5 h-3.5 text-[#ACC00B]" />
                                    FAIE v3
                                  </span>
                              ...
                              <div className="flex flex-col sm:items-end justify-center bg-slate-50 p-3 rounded-xl border border-slate-200/80 text-xs font-mono shrink-0 space-y-1">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-[#ACC00B] font-bold">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="space-y-2.5 relative pt-1">
                                ...
                                <div className={`relative flex items-start gap-3 p-3 rounded-xl border transition-all ${
                                    ...
                                    {evaluatingSubmission.status === "QUEUED" ? (
                                      <div className="h-6 w-6 rounded-full bg-rose-100 border border-rose-300 flex items-center justify-center">
                                        <span className="relative flex h-2 w-2">
                                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ACC00B] opacity-75"></span>
                                          <span className="relative inline-flex rounded-full h-2 w-2 bg-[#ACC00B]"></span>
                                        </span>
                                      </div>
                                    ) : (
                                  ...
                                  <div className="space-y-0.5 min-w-0 flex-1">
                                    <div className="flex items-center justify-between gap-2">
                                      <h4 className={`text-xs font-bold ${evaluatingSubmission.status === "QUEUED" ? "text-[#ACC00B]" : "text-slate-800"}`}>
                                        Repository Analysis
                                      </h4>
                                      <span className={`text-[9px] font-mono px-2 py-0.5 rounded border ${
                                        evaluatingSubmission.status === "QUEUED"
                                          ? "text-[#ACC00B] bg-rose-100 border-rose-200 font-semibold"
                                ...
                                <div className={`relative flex items-start gap-3 p-3 rounded-xl border transition-all ${
                                  ...
                                  <div className="space-y-0.5 min-w-0 flex-1">
                                    <div className="flex items-center justify-between gap-2">
                                      <h4 className={`text-xs font-bold ${evaluatingSubmission.status === "EVALUATING" ? "text-[#ACC00B]" : "text-slate-500"}`}>
                                        AST Analysis
                                      </h4>
                                      <span className={`text-[9px] font-mono px-2 py-0.5 rounded border ${
                                        evaluatingSubmission.status === "EVALUATING"
                            ...
                            <div className="space-y-2 pt-2 border-t border-[#F1F5F9]">
                              <div className="flex items-center justify-between text-xs font-medium text-[#0F172A]">
                                <span className="flex items-center gap-2 text-xs">
                                  <Loader2 className="h-3.5 w-3.5 text-[#ACC00B] animate-spin" />
                              ...
                              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden relative border border-slate-200/50">
                                <div
                                  className="h-full bg-gradient-to-r from-[#ACC00B] to-rose-500 rounded-full transition-all duration-500"
                        ...
                        {submissionStep === 1 && (
                          <div className="space-y-4 max-w-lg">
                            ...
                            <div className="flex justify-end pt-4">
                              <Button
                                type="button"
                                className="bg-[#ACC00B] text-white font-bold"
                                onClick={() => {
                        ...
                        {submissionStep === 3 && (
                          <div className="space-y-4 max-w-lg">
                            ...
                            <div className="space-y-1">
                              ...
                              <textarea
                                className="w-full p-2.5 border rounded-xl text-xs focus:ring-[#ACC00B] focus:border-[#ACC00B]"
                                rows={3}
                                value={detailedDesc}
                            ...
                            {astCheckResult && (
                              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center gap-3">
                                {astCheckResult === "analyzing" ? (
                                  <>
                                    <RefreshCw className="h-5 w-5 text-[#ACC00B] animate-spin shrink-0" />
                            ...
                            <tbody className="divide-y divide-slate-100">
                              {submissionAttempts.map((attempt, idx) => (
                                <tr key={idx} className="hover:bg-slate-50/50">
                                  ...
                                  <td className="p-3 font-bold text-[#ACC00B]">{attempt.score}/100 ({attempt.grade})</td>
                                  <td className="p-3">
                                  ...
                                  <td className="p-3">
                                    {attempt.reports && attempt.reports.length > 0 ? (
                                      <button
                                        ...
                                        className="text-[#ACC00B] hover:underline font-bold"
                                      >
                                        View Report
                                      </button>
                                    ) : (
                  ...
                  <Card className="p-6 bg-white border-[#E2E8F0] shadow-sm rounded-2xl animate-in fade-in duration-200 space-y-4">
                    ...
                    {loadingLeaderboard ? (
                      <div className="flex justify-center p-8">
                        <RefreshCw className="h-6 w-6 animate-spin text-[#ACC00B]" />
                      </div>
                          ...
                          <tbody className="divide-y divide-slate-100">
                            {leaderboardList.map((row, idx) => {
                              ...
                              return (
                                ...
                                <td className="p-3 font-bold text-[#ACC00B]">{row.score}/100</td>
                                <td className="p-3">
                ...
                <form onSubmit={handleRegisterSubmit}>
                  <Card className="rounded-2xl border-[#E2E8F0] shadow-sm bg-white overflow-hidden">
                    ...
                    <CardContent className="p-6 space-y-6">
                      ...
                      <div className="space-y-3 pt-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          ...
                          <div
                            ...
                            className={`p-4 border rounded-xl flex items-start gap-3 cursor-pointer transition-all ${
                              participationMode === "solo"
                                ? "border-[#ACC00B] bg-[#ACC00B]/5"
                                : "border-[#E2E8F0] bg-white hover:bg-[#F8FAFC]"
                            }`}
                          >
                            <UserIcon className={`h-5 w-5 shrink-0 mt-0.5 ${participationMode === "solo" ? "text-[#ACC00B]" : "text-[#475569]"}`} />
                            <div>
                          ...
                          >
                            <Users className={`h-5 w-5 shrink-0 mt-0.5 ${participationMode === "create_team" ? "text-[#ACC00B]" : "text-[#475569]"}`} />
                            <div>
                          ...
                          >
                            <Users className={`h-5 w-5 shrink-0 mt-0.5 ${participationMode === "join_team" ? "text-[#ACC00B]" : "text-[#475569]"}`} />
                            <div>
                    ...
                    <CardFooter className="flex justify-end gap-2 bg-[#F8FAFC]/30 border-t border-[#F1F5F9] p-4">
                      <Button
                        type="submit"
                        className="bg-[#ACC00B] text-white hover:bg-[#D8005C] shadow-sm font-bold"
            ...
            >
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card className="p-6 space-y-4 bg-white border-[#E2E8F0] shadow-xs rounded-2xl">
                  <h3 className="font-heading text-sm font-bold text-[#0F172A] border-b border-[#F1F5F9] pb-2 flex items-center gap-2">
                    <Info className="h-4 w-4 text-[#ACC00B]" />
                ...
                <Card className="p-6 space-y-4 bg-white border-[#E2E8F0] shadow-xs rounded-2xl">
                  <h3 className="font-heading text-sm font-bold text-[#0F172A] border-b border-[#F1F5F9] pb-2 flex items-center gap-2">
                    <FileCode2 className="h-4 w-4 text-[#ACC00B]" />
                ...
                <Card className="p-6 space-y-4 bg-white border-[#E2E8F0] shadow-xs rounded-2xl">
                  <h3 className="font-heading text-sm font-bold text-[#0F172A] border-b border-[#F1F5F9] pb-2 flex items-center gap-2">
                    <Calendar className="h-4 w-4 text-[#ACC00B]" />
                  ...
                  <div className="space-y-4">
                    {hackathon.rounds.map((round, idx) => (
                      <div key={idx} className="flex gap-4 relative">
                        ...
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[rgba(172,192,11,0.08)] border border-[#FFCCD5] text-[#ACC00B] text-xs font-bold">
                          {idx + 1}
                        </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <Card className="p-6 text-center space-y-4 border-[#E2E8F0] shadow-sm bg-white rounded-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#ACC00B] to-[#FFD60A]" />
                  <div className="space-y-1 pt-1">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#ACC00B] text-white hover:bg-[#D8005C] shadow-md py-3 text-xs font-bold rounded-xl"
                    rightIcon={<ArrowRight className="h-4 w-4" />}
                  >
                    Register Now
                  </Button>
                ...
                <Card className="p-5 space-y-3 bg-white border-[#E2E8F0] shadow-xs rounded-2xl">
                  <h3 className="font-heading text-xs font-bold uppercase tracking-wider text-[#0F172A] border-b border-[#F1F5F9] pb-2 flex items-center gap-2">
                    <CheckSquare className="h-3.5 w-3.5 text-[#ACC00B]" />
                    ...
                    <ul className="space-y-2.5 text-[11px] text-[#475569] leading-relaxed">
                      {hackathon.rules.map((rule, idx) => (
                        <li key={idx} className="flex gap-2 items-start">
                          <span className="text-[#ACC00B] font-bold mt-0.5">•</span>
                          <span>{rule}</span>
                        </li>
                      ))}
                    </ul>
