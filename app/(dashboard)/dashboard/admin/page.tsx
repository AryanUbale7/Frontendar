        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 rounded-[16px] border border-[#E2E8F0] bg-white p-6 shadow-sm relative overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#00E5FF]/5 via-transparent to-transparent pointer-events-none" />
              <div className="space-y-1 relative z-10">
                <div className="flex items-center gap-2">
                  <Badge variant="solid" size="sm" className="bg-[#00E5FF] text-white">
                    Platform Insights
                  </Badge>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card className="p-5 flex items-center justify-between border-[#E2E8F0] shadow-sm hover:border-[#00E5FF]/30 transition-all duration-200">
                <div>
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-[12px] bg-[#00E5FF]/5 text-[#00E5FF]">
            ...
            <Card className="rounded-2xl border-[#E2E8F0] shadow-sm bg-white overflow-hidden">
              <CardHeader className="py-4 border-b border-[#F1F5F9] bg-[#F8FAFC]/50 flex flex-row items-center justify-between">
                ...
                <Badge variant="outline" className="text-[#00E5FF] border-[#00E5FF]/20 bg-[#00E5FF]/5 font-bold">
                  Live Feed
                </Badge>
              </CardHeader>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-[#00E5FF] font-bold hover:underline"
                >
                            ...
                            {adminSubmissions.map((sub, idx) => (
                              <tr key={idx} className="hover:bg-slate-50/50">
                                ...
                                <td className="p-3 font-mono text-slate-500">
                                  <a href={sub.repoUrl} target="_blank" rel="noreferrer" className="text-[#00E5FF] hover:underline truncate max-w-[200px] block">
                                ...
                                <td className="p-3 font-bold text-[#00E5FF]">{sub.score !== null ? `${sub.score}/100` : "Pending"}</td>
                                <td className="p-3">
              ...
              <form onSubmit={handleCreateHackathonSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-1.5 w-full">
                          ...
                          <textarea
                            ...
                            className="flex min-h-[100px] w-full rounded-[12px] border border-[#E2E8F0] bg-white px-3 py-2 text-sm text-[#0F172A] placeholder:text-[#94A3B8] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00E5FF] focus-visible:border-transparent"
                          />
                        </div>
                      </div>
                    </Card>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-1.5 w-full">
                          ...
                          <textarea
                            ...
                            className="flex min-h-[120px] w-full rounded-[12px] border border-[#E2E8F0] bg-white px-3 py-2 text-sm text-[#0F172A] placeholder:text-[#94A3B8] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00E5FF] focus-visible:border-transparent"
                          />
                        </div>
                        ...
                        <div className="space-y-3 pt-2">
                          <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-1.5">
                            ...
                            <Button
                              ...
                              className="h-6 text-[10px] border-[#00E5FF] text-[#00E5FF] hover:bg-[#00E5FF]/10"
                            >
                              Add Test Case
                            </Button>
                          </div>
                    ...
                    <Card className="p-6 space-y-4">
                      <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-2">
                        ...
                        <Button
                          ...
                          className="h-7 text-xs border-[#00E5FF] text-[#00E5FF] hover:bg-[#00E5FF]/10"
                        >
                          Add Rule
                        </Button>
                      </div>
                        ...
                        {rules.map((rule, idx) => (
                          <div key={idx} className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              className="flex h-9 flex-1 rounded-[12px] border border-[#E2E8F0] bg-white px-3 text-xs text-[#0F172A] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00E5FF]"
                            />
                            <button
                              type="button"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className="flex h-10 w-full rounded-[12px] border border-[#E2E8F0] bg-white px-3 py-2 text-sm text-[#0F172A] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00E5FF] focus-visible:border-transparent"
                            required
                          />
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <Card className="p-6 space-y-4">
                      ...
                      {bannerImage ? (
                        ...
                        <div className="space-y-3">
                          <div
                            onClick={() => fileInputRef.current?.click()}
                            className="flex flex-col items-center justify-center h-28 w-full border-2 border-dashed border-[#CBD5E1] rounded-lg bg-[#F8FAFC] hover:bg-slate-100 hover:border-[#00E5FF] cursor-pointer transition-all p-4 text-center group"
                          >
                            <ImageIcon className="h-6 w-6 text-[#94A3B8] group-hover:text-[#00E5FF] mb-1.5 transition-colors" />
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="grid grid-cols-4 gap-1.5">
                              {[
                                { label: "Pink Glow", bg: "linear-gradient(135deg, #00E5FF, #FFD60A)" },
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-[#00E5FF] text-white hover:bg-[#D8005C] shadow-md py-3 text-sm font-extrabold rounded-xl"
                ...
                {hackathons.length > 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {hackathons.map((hackathon) => (
                      <Card key={hackathon.id} className="overflow-hidden border-[#E2E8F0] shadow-sm bg-white rounded-2xl flex flex-col hover:border-[#00E5FF]/40 transition-all">
                          ...
                          {(() => {
                           ...
                           <div className="flex flex-wrap items-center gap-x-3 gap-y-2 w-full sm:w-auto sm:justify-end">
                            ...
                            <button
                              ...
                              className="text-[#475569] hover:text-[#00E5FF] flex items-center gap-0.5 font-bold"
                            >
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                <h1 className="font-heading text-2xl font-extrabold text-[#0F172A] flex items-center gap-2">
                  <Scale className="h-6 w-6 text-[#00E5FF]" />
            ...
            {judgingHackathonId && judgingStats && (
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <Card className="p-4 bg-white border-[#E2E8F0] flex flex-col justify-between">
                  ...
                  <span className="text-2xl font-black text-[#00E5FF] mt-1">{judgingStats.evaluatingCount}</span>
                </Card>
                <Card className="p-4 bg-white border-[#E2E8F0] flex flex-col justify-between">
                            ...
                            <td className="p-4 text-right">
                              <div className="flex justify-end gap-1.5">
                                ...
                                <Button
                                  variant="default"
                                  size="sm"
                                  className={`h-7 px-2.5 text-[10px] font-bold rounded-lg ${sub.status === "FAILED" ? "bg-[#00E5FF] hover:bg-[#D8005C] text-white" : "bg-slate-200 text-slate-400 cursor-not-allowed"}`}
      ...
      case "leaderboard":
        return (
          ...
          >
            <div>
              <h1 className="font-heading text-2xl font-extrabold text-[#0F172A] flex items-center gap-2">
                <Medal className="h-6 w-6 text-[#00E5FF]" />
                        ...
                        return (
                          <tr key={reg.id} className="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td className="p-4 space-y-0.5">
                              ...
                              {reg.teamName && (
                                <div className="text-[10px] font-bold text-[#00E5FF]">{reg.teamName}</div>
                              )}
                            </td>
                            <td className="p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="p-6 border border-[#E2E8F0] shadow-xs">
                    <h3 className="text-xs font-black uppercase text-[#64748B] tracking-wider mb-4 flex items-center gap-1.5">
                      <div className="h-2.5 w-2.5 rounded-full bg-[#00E5FF] animate-pulse" />
                  ...
                  <Card className="p-6 border border-[#E2E8F0] shadow-xs">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-xs border-b border-[#F1F5F9] pb-2">
                        ...
                        <span className="font-bold text-[#00E5FF]">{systemMetrics.db.evaluating}</span>
                      </div>
                      <div className="flex items-center justify-between text-xs pb-1">
          ...
          >
            ...
            <Card className="rounded-2xl border-[#E2E8F0] shadow-sm bg-white overflow-hidden">
              ...
              <CardFooter className="flex justify-end gap-2 bg-[#F8FAFC]/30 border-t border-[#F1F5F9] p-4">
                <Button onClick={handleSaveSystemConfig} className="bg-[#00E5FF] text-white hover:bg-[#D8005C] shadow-sm font-bold" size="sm" leftIcon={<Sparkles className="h-4 w-4" />}>
                  Save System Config
                </Button>
              </CardFooter>
            </Card>
