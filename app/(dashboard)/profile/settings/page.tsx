  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs text-[#475569]">
        ...
        <Link href="/profile" className="hover:text-[#DEE32E]">
          User Profile
        </Link>
        <ChevronRight className="h-3 w-3 text-[#94A3B8]" />
      ...
      <div className="space-y-1.5">
        <h1 className="font-heading text-2xl md:text-3xl font-extrabold text-[#0F172A] flex items-center gap-2">
          <Settings className="h-7 w-7 text-[#DEE32E]" />
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-[#F1F5F9]">
                  <div className="space-y-1.5 w-full">
                    ...
                    <div className="flex h-10 w-full rounded-[12px] border border-[#E2E8F0] bg-white overflow-hidden focus-within:ring-2 focus-within:ring-[#DEE32E]">
