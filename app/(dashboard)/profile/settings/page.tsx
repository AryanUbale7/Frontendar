  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs text-[#475569]">
        ...
        <Link href="/profile" className="hover:text-[#00E5FF]">
          User Profile
        </Link>
        <ChevronRight className="h-3 w-3 text-[#94A3B8]" />
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-[#F1F5F9]">
                  <div className="space-y-1.5 w-full">
                    ...
                    <div className="flex h-10 w-full rounded-[12px] border border-[#E2E8F0] bg-white overflow-hidden focus-within:ring-2 focus-within:ring-[#00E5FF]">
